...
let HomeComponent = class HomeComponent {
    ...
    click() {
        this.multiplier.subscribe(res => {
            ...
            this.store.dispatch(new _store_actions_score_actions__WEBPACK_IMPORTED_MODULE_3__["AddScore"]({ score: points }));
            this.store.dispatch(new _store_actions_allScore_actions__WEBPACK_IMPORTED_MODULE_4__["AddAllScore"]({ allScore: points }));
        });
    }
    tick() {
        this.multiplier.subscribe(res => {
    ...
    upgrade(id) {
        this.score.subscribe(res => {
            if (res.score < this.upgrades[id].price) {
                ...
                this.store.dispatch(new _store_actions_score_actions__WEBPACK_IMPORTED_MODULE_3__["SubtractScore"]({ score: this.upgrades[id].price }));
                this.store.dispatch(new _store_actions_multiplier_actions__WEBPACK_IMPORTED_MODULE_5__["IncrementMult"]({ pointsPerClick: this.upgrades[id].pointsPerClick, pointsPerSecond: this.upgrades[id].pointsPerSec }));
            }
        });
    }
    upgradeSeconds() {
...
const ADD_ALLSCORE = '[ALLSCORE] Add';
class AddAllScore {
    constructor(payload) {
...
const INCR_MULTIPLIERS = '[MULTIPLIERS] Increment';
const DECR_MULTIPLIERS = '[MULTIPLIERS] Decrement';
class IncrementMult {
    constructor(payload) {
        this.payload = payload;
...
const ADD_SCORE = '[SCORE] Add';
const SUBTRACT_SCORE = '[SCORE] Subtract';
class AddScore {
    constructor(payload) {
        this.payload = payload;
        this.type = ADD_SCORE;
...
function allScoreReducer(state = getScore(), action) {
    switch (action.type) {
...
function multiplierReducer(state = getScore(), action) {
    switch (action.type) {
...
function scoreReducer(state = getScore(), action) {
    switch (action.type) {
