...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.updateStats = function (username, data, token2) {
        this.tokenAuth2 = {
    ...
    DataService.prototype.getStatsByUsername = function (username, token2) {
        this.tokenAuth = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                "Content-Type": "application/json",
                "Authorization": "Bearer " + token2,
    ...
    HomeComponent.prototype.upgradeStats = function () {
        ...
        this.statistic.subscribe(function (res) {
            if (res === undefined || res.upgradeLevels === undefined) {
                ...
                _this.data.updateStats(localStorage.getItem('user'), userStats, localStorage.getItem('token')).subscribe(function (res) {
                });
            }
        }).unsubscribe();
    };
    HomeComponent.prototype.openWindow = function () {
...
var LoadingComponent = /** @class */ (function () {
    function LoadingComponent(store, router, sc) {
        this.store = store;
        this.router = router;
        this.sc = sc;
    }
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.store.subscribe(function (res) {
            console.log(res);
        }).unsubscribe();
    };
    LoginComponent.prototype.submit = function () {
        ...
        this.sc.login(this.login.value).subscribe(function (res) {
            ...
            localStorage.setItem('user', _this.f.username.value);
...
var WelcomeComponent = /** @class */ (function () {
    ...
    WelcomeComponent.prototype.ngOnInit = function () {
        ...
        this.sc.getAllStats().subscribe(function (res) {
            var e_1, _a;
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](res['stats']), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
                    var obj = {
...
var INITIAL_UPDATE = '[ACTUAL_UPGRADES] InicialNextUpdate';
...
var ActionsTypes = /** @class */ (function () {
...
var UpgradesEffects = /** @class */ (function () {
    function UpgradesEffects(actions$, dataService, store) {
        ...
        this.updateUpgrades$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])('[STATS] UpdateStatsByUpgrade'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (merge) { return _this.store.select('statistic')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["exhaustMap"])(function (stats) { return [({ type: '[ACTUAL_UPGRADES] InicialNextUpdate', payload: { id: merge['payload']['id'], upgradeLvl: stats['upgradeLevels'][merge['payload']['id']]['upgradeLvl'] } })]; })); })); });
        this.updateUpgrades2$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])('[ACTUAL_UPGRADES] InicialNextUpdate'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (merge) { return _this.store.select('upgrades')
